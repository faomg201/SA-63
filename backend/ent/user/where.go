...
// HasUSERRECORD applies the HasEdge predicate on the "USERRECORD" edge.
...
// HasUSERRECORDWith applies the HasEdge predicate on the "USERRECORD" edge with a given conditions (other predicates).
