...
const (
	...
	// EdgeUSERRECORD holds the string denoting the userrecord edge name in mutations.
	EdgeUSERRECORD = "USERRECORD"

	// Table holds the table name of the user in the database.
	Table = "users"
	// USERRECORDTable is the table the holds the USERRECORD relation/edge.
	...
	// USERRECORDColumn is the table column denoting the USERRECORD relation/edge.
	USERRECORDColumn = "user_userrecord"
)
