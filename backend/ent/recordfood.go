...
type Recordfood struct {
	...
	foodmenu_foodmenurecord   *int
	mainingre_mainingrerecord *int
	source_sourcerecord       *int
	user_userrecord           *int
}
...
func (*Recordfood) fkValues() []interface{} {
	return []interface{}{
		&sql.NullInt64{}, // foodmenu_foodmenurecord
		&sql.NullInt64{}, // mainingre_mainingrerecord
		&sql.NullInt64{}, // source_sourcerecord
		&sql.NullInt64{}, // user_userrecord
	}
}
...
func (r *Recordfood) assignValues(values ...interface{}) error {
	...
	if len(values) == len(recordfood.ForeignKeys) {
		if value, ok := values[0].(*sql.NullInt64); !ok {
			return fmt.Errorf("unexpected type %T for edge-field foodmenu_foodmenurecord", value)
		} else if value.Valid {
			r.foodmenu_foodmenurecord = new(int)
			*r.foodmenu_foodmenurecord = int(value.Int64)
		}
		if value, ok := values[1].(*sql.NullInt64); !ok {
			return fmt.Errorf("unexpected type %T for edge-field mainingre_mainingrerecord", value)
		} else if value.Valid {
			r.mainingre_mainingrerecord = new(int)
			*r.mainingre_mainingrerecord = int(value.Int64)
		}
		if value, ok := values[2].(*sql.NullInt64); !ok {
			return fmt.Errorf("unexpected type %T for edge-field source_sourcerecord", value)
		} else if value.Valid {
			r.source_sourcerecord = new(int)
			*r.source_sourcerecord = int(value.Int64)
		}
		if value, ok := values[3].(*sql.NullInt64); !ok {
			return fmt.Errorf("unexpected type %T for edge-field user_userrecord", value)
		} else if value.Valid {
			r.user_userrecord = new(int)
			*r.user_userrecord = int(value.Int64)
		}
	}
	return nil
}
