...
type SourceEdges struct {
	// SOURCERECORD holds the value of the SOURCERECORD edge.
...
func (e SourceEdges) SOURCERECORDOrErr() ([]*Recordfood, error) {
	...
	return nil, &NotLoadedError{edge: "SOURCERECORD"}
}
...
// QuerySOURCERECORD queries the SOURCERECORD edge of the Source.
