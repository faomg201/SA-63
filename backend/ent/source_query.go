...
type SourceQuery struct {
	...
	// eager-loading edges.
	withSOURCERECORD *RecordfoodQuery
...
// QuerySOURCERECORD chains the current query on the SOURCERECORD edge.
func (sq *SourceQuery) QuerySOURCERECORD() *RecordfoodQuery {
	query := &RecordfoodQuery{config: sq.config}
...
//  WithSOURCERECORD tells the query-builder to eager-loads the nodes that are connected to
// the "SOURCERECORD" edge. The optional arguments used to configure the query builder of the edge.
func (sq *SourceQuery) WithSOURCERECORD(opts ...func(*RecordfoodQuery)) *SourceQuery {
	query := &RecordfoodQuery{config: sq.config}
	for _, opt := range opts {
		opt(query)
	}
	sq.withSOURCERECORD = query
	return sq
}
...
//
//	client.Source.Query().
//		GroupBy(source.FieldSOURCENAME).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
//
...
func (sq *SourceQuery) sqlAll(ctx context.Context) ([]*Source, error) {
	...
	if query := sq.withSOURCERECORD; query != nil {
		...
		query.Where(predicate.Recordfood(func(s *sql.Selector) {
			s.Where(sql.InValues(source.SOURCERECORDColumn, fks...))
		}))
		...
		for _, n := range neighbors {
			fk := n.source_sourcerecord
			if fk == nil {
				return nil, fmt.Errorf(`foreign-key "source_sourcerecord" is nil for node %v`, n.ID)
			}
			node, ok := nodeids[*fk]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "source_sourcerecord" returned %v for node %v`, *fk, n.ID)
			}
			node.Edges.SOURCERECORD = append(node.Edges.SOURCERECORD, n)
		}
	}
...
func (sq *SourceQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if ps := sq.order; len(ps) > 0 {
		_spec.Order = func(selector *sql.Selector) {
			for i := range ps {
				ps[i](selector, source.ValidColumn)
			}
		}
	}
	return _spec
...
func (sgb *SourceGroupBy) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{source.Label}
	default:
		err = fmt.Errorf("ent: SourceGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (sgb *SourceGroupBy) StringX(ctx context.Context) string {
...
func (sgb *SourceGroupBy) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{source.Label}
	default:
		err = fmt.Errorf("ent: SourceGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (sgb *SourceGroupBy) IntX(ctx context.Context) int {
	v, err := sgb.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (sgb *SourceGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{source.Label}
	default:
		err = fmt.Errorf("ent: SourceGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (sgb *SourceGroupBy) Float64X(ctx context.Context) float64 {
...
func (sgb *SourceGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{source.Label}
	default:
		err = fmt.Errorf("ent: SourceGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (sgb *SourceGroupBy) BoolX(ctx context.Context) bool {
	v, err := sgb.Bool(ctx)
	if err != nil {
		panic(err)
	}
...
func (sgb *SourceGroupBy) sqlQuery() *sql.Selector {
	...
	for _, fn := range sgb.fns {
		columns = append(columns, fn(selector, source.ValidColumn))
	}
...
func (ss *SourceSelect) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{source.Label}
	default:
		err = fmt.Errorf("ent: SourceSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (ss *SourceSelect) StringX(ctx context.Context) string {
	v, err := ss.String(ctx)
	if err != nil {
		panic(err)
	}
...
func (ss *SourceSelect) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{source.Label}
	default:
		err = fmt.Errorf("ent: SourceSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (ss *SourceSelect) IntX(ctx context.Context) int {
	v, err := ss.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (ss *SourceSelect) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{source.Label}
	default:
		err = fmt.Errorf("ent: SourceSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (ss *SourceSelect) Float64X(ctx context.Context) float64 {
...
func (ss *SourceSelect) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{source.Label}
	default:
		err = fmt.Errorf("ent: SourceSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (ss *SourceSelect) BoolX(ctx context.Context) bool {
	v, err := ss.Bool(ctx)
	if err != nil {
		panic(err)
	}
