...
// HasFOODMENURECORD applies the HasEdge predicate on the "FOODMENURECORD" edge.
...
// HasFOODMENURECORDWith applies the HasEdge predicate on the "FOODMENURECORD" edge with a given conditions (other predicates).
