...
type FOODMENUMutation struct {
	...
	_FOODMENURECORD        map[int]struct{}
	removed_FOODMENURECORD map[int]struct{}
	cleared_FOODMENURECORD bool
	done                   bool
...
func (m *FOODMENUMutation) AddFOODMENURECORDIDs(ids ...int) {
	if m._FOODMENURECORD == nil {
		m._FOODMENURECORD = make(map[int]struct{})
	}
	for i := range ids {
		m._FOODMENURECORD[ids[i]] = struct{}{}
	}
}

// ClearFOODMENURECORD clears the FOODMENURECORD edge to Recordfood.
func (m *FOODMENUMutation) ClearFOODMENURECORD() {
	m.cleared_FOODMENURECORD = true
}

// FOODMENURECORDCleared returns if the edge FOODMENURECORD was cleared.
func (m *FOODMENUMutation) FOODMENURECORDCleared() bool {
	return m.cleared_FOODMENURECORD
}

// RemoveFOODMENURECORDIDs removes the FOODMENURECORD edge to Recordfood by ids.
func (m *FOODMENUMutation) RemoveFOODMENURECORDIDs(ids ...int) {
	if m.removed_FOODMENURECORD == nil {
		m.removed_FOODMENURECORD = make(map[int]struct{})
	}
	for i := range ids {
		m.removed_FOODMENURECORD[ids[i]] = struct{}{}
	}
}

// RemovedFOODMENURECORD returns the removed ids of FOODMENURECORD.
func (m *FOODMENUMutation) RemovedFOODMENURECORDIDs() (ids []int) {
	for id := range m.removed_FOODMENURECORD {
		ids = append(ids, id)
	}
	return
}

// FOODMENURECORDIDs returns the FOODMENURECORD ids in the mutation.
func (m *FOODMENUMutation) FOODMENURECORDIDs() (ids []int) {
	for id := range m._FOODMENURECORD {
		ids = append(ids, id)
	}
	return
}

// ResetFOODMENURECORD reset all changes of the "FOODMENURECORD" edge.
func (m *FOODMENUMutation) ResetFOODMENURECORD() {
	m._FOODMENURECORD = nil
	m.cleared_FOODMENURECORD = false
	m.removed_FOODMENURECORD = nil
}
...
func (m *FOODMENUMutation) AddedIDs(name string) []ent.Value {
	...
	case foodmenu.EdgeFOODMENURECORD:
		ids := make([]ent.Value, 0, len(m._FOODMENURECORD))
		for id := range m._FOODMENURECORD {
			ids = append(ids, id)
		}
		return ids
...
func (m *FOODMENUMutation) RemovedIDs(name string) []ent.Value {
	switch name {
	case foodmenu.EdgeFOODMENURECORD:
		ids := make([]ent.Value, 0, len(m.removed_FOODMENURECORD))
		for id := range m.removed_FOODMENURECORD {
			ids = append(ids, id)
		}
		return ids
...
type MainingreMutation struct {
	...
	clearedFields           map[string]struct{}
	_MAININGRERECORD        map[int]struct{}
	removed_MAININGRERECORD map[int]struct{}
	cleared_MAININGRERECORD bool
	done                    bool
...
// AddMAININGRERECORDIDs adds the MAININGRERECORD edge to Recordfood by ids.
func (m *MainingreMutation) AddMAININGRERECORDIDs(ids ...int) {
	if m._MAININGRERECORD == nil {
		m._MAININGRERECORD = make(map[int]struct{})
	}
	for i := range ids {
		m._MAININGRERECORD[ids[i]] = struct{}{}
	}
}

// ClearMAININGRERECORD clears the MAININGRERECORD edge to Recordfood.
func (m *MainingreMutation) ClearMAININGRERECORD() {
	m.cleared_MAININGRERECORD = true
}

// MAININGRERECORDCleared returns if the edge MAININGRERECORD was cleared.
func (m *MainingreMutation) MAININGRERECORDCleared() bool {
	return m.cleared_MAININGRERECORD
}

// RemoveMAININGRERECORDIDs removes the MAININGRERECORD edge to Recordfood by ids.
func (m *MainingreMutation) RemoveMAININGRERECORDIDs(ids ...int) {
	if m.removed_MAININGRERECORD == nil {
		m.removed_MAININGRERECORD = make(map[int]struct{})
	}
	for i := range ids {
		m.removed_MAININGRERECORD[ids[i]] = struct{}{}
	}
}

// RemovedMAININGRERECORD returns the removed ids of MAININGRERECORD.
func (m *MainingreMutation) RemovedMAININGRERECORDIDs() (ids []int) {
	for id := range m.removed_MAININGRERECORD {
		ids = append(ids, id)
	}
	return
}

// MAININGRERECORDIDs returns the MAININGRERECORD ids in the mutation.
func (m *MainingreMutation) MAININGRERECORDIDs() (ids []int) {
	for id := range m._MAININGRERECORD {
		ids = append(ids, id)
	}
	return
}

// ResetMAININGRERECORD reset all changes of the "MAININGRERECORD" edge.
func (m *MainingreMutation) ResetMAININGRERECORD() {
	m._MAININGRERECORD = nil
	m.cleared_MAININGRERECORD = false
	m.removed_MAININGRERECORD = nil
}
...
func (m *MainingreMutation) AddedIDs(name string) []ent.Value {
	...
	case mainingre.EdgeMAININGRERECORD:
		ids := make([]ent.Value, 0, len(m._MAININGRERECORD))
		for id := range m._MAININGRERECORD {
			ids = append(ids, id)
		}
		return ids
...
func (m *MainingreMutation) RemovedIDs(name string) []ent.Value {
	switch name {
	case mainingre.EdgeMAININGRERECORD:
		ids := make([]ent.Value, 0, len(m.removed_MAININGRERECORD))
		for id := range m.removed_MAININGRERECORD {
			ids = append(ids, id)
		}
		return ids
...
type SourceMutation struct {
	...
	_SOURCE_TLE          *string
	clearedFields        map[string]struct{}
	_SOURCERECORD        map[int]struct{}
	removed_SOURCERECORD map[int]struct{}
	cleared_SOURCERECORD bool
	done                 bool
...
// AddSOURCERECORDIDs adds the SOURCERECORD edge to Recordfood by ids.
func (m *SourceMutation) AddSOURCERECORDIDs(ids ...int) {
	if m._SOURCERECORD == nil {
		m._SOURCERECORD = make(map[int]struct{})
	}
	for i := range ids {
		m._SOURCERECORD[ids[i]] = struct{}{}
	}
}

// ClearSOURCERECORD clears the SOURCERECORD edge to Recordfood.
func (m *SourceMutation) ClearSOURCERECORD() {
	m.cleared_SOURCERECORD = true
}

// SOURCERECORDCleared returns if the edge SOURCERECORD was cleared.
func (m *SourceMutation) SOURCERECORDCleared() bool {
	return m.cleared_SOURCERECORD
}

// RemoveSOURCERECORDIDs removes the SOURCERECORD edge to Recordfood by ids.
func (m *SourceMutation) RemoveSOURCERECORDIDs(ids ...int) {
	if m.removed_SOURCERECORD == nil {
		m.removed_SOURCERECORD = make(map[int]struct{})
	}
	for i := range ids {
		m.removed_SOURCERECORD[ids[i]] = struct{}{}
	}
}

// RemovedSOURCERECORD returns the removed ids of SOURCERECORD.
func (m *SourceMutation) RemovedSOURCERECORDIDs() (ids []int) {
	for id := range m.removed_SOURCERECORD {
		ids = append(ids, id)
	}
	return
}

// SOURCERECORDIDs returns the SOURCERECORD ids in the mutation.
func (m *SourceMutation) SOURCERECORDIDs() (ids []int) {
	for id := range m._SOURCERECORD {
		ids = append(ids, id)
	}
	return
}

// ResetSOURCERECORD reset all changes of the "SOURCERECORD" edge.
func (m *SourceMutation) ResetSOURCERECORD() {
	m._SOURCERECORD = nil
	m.cleared_SOURCERECORD = false
	m.removed_SOURCERECORD = nil
}
...
func (m *SourceMutation) AddedIDs(name string) []ent.Value {
	...
	case source.EdgeSOURCERECORD:
		ids := make([]ent.Value, 0, len(m._SOURCERECORD))
		for id := range m._SOURCERECORD {
			ids = append(ids, id)
		}
		return ids
...
func (m *SourceMutation) RemovedIDs(name string) []ent.Value {
	switch name {
	case source.EdgeSOURCERECORD:
		ids := make([]ent.Value, 0, len(m.removed_SOURCERECORD))
		for id := range m.removed_SOURCERECORD {
			ids = append(ids, id)
		}
		return ids
...
type UserMutation struct {
	...
	_USER_NAME         *string
	clearedFields      map[string]struct{}
	_USERRECORD        map[int]struct{}
	removed_USERRECORD map[int]struct{}
	cleared_USERRECORD bool
	done               bool
...
// AddUSERRECORDIDs adds the USERRECORD edge to Recordfood by ids.
func (m *UserMutation) AddUSERRECORDIDs(ids ...int) {
	if m._USERRECORD == nil {
		m._USERRECORD = make(map[int]struct{})
	}
	for i := range ids {
		m._USERRECORD[ids[i]] = struct{}{}
	}
}

// ClearUSERRECORD clears the USERRECORD edge to Recordfood.
func (m *UserMutation) ClearUSERRECORD() {
	m.cleared_USERRECORD = true
}

// USERRECORDCleared returns if the edge USERRECORD was cleared.
func (m *UserMutation) USERRECORDCleared() bool {
	return m.cleared_USERRECORD
}

// RemoveUSERRECORDIDs removes the USERRECORD edge to Recordfood by ids.
func (m *UserMutation) RemoveUSERRECORDIDs(ids ...int) {
	if m.removed_USERRECORD == nil {
		m.removed_USERRECORD = make(map[int]struct{})
	}
	for i := range ids {
		m.removed_USERRECORD[ids[i]] = struct{}{}
	}
}

// RemovedUSERRECORD returns the removed ids of USERRECORD.
func (m *UserMutation) RemovedUSERRECORDIDs() (ids []int) {
	for id := range m.removed_USERRECORD {
		ids = append(ids, id)
	}
	return
}

// USERRECORDIDs returns the USERRECORD ids in the mutation.
func (m *UserMutation) USERRECORDIDs() (ids []int) {
	for id := range m._USERRECORD {
		ids = append(ids, id)
	}
	return
}

// ResetUSERRECORD reset all changes of the "USERRECORD" edge.
func (m *UserMutation) ResetUSERRECORD() {
	m._USERRECORD = nil
	m.cleared_USERRECORD = false
	m.removed_USERRECORD = nil
}
...
func (m *UserMutation) AddedIDs(name string) []ent.Value {
	...
	case user.EdgeUSERRECORD:
		ids := make([]ent.Value, 0, len(m._USERRECORD))
		for id := range m._USERRECORD {
			ids = append(ids, id)
		}
		return ids
...
func (m *UserMutation) RemovedIDs(name string) []ent.Value {
	switch name {
	case user.EdgeUSERRECORD:
		ids := make([]ent.Value, 0, len(m.removed_USERRECORD))
		for id := range m.removed_USERRECORD {
			ids = append(ids, id)
		}
		return ids
