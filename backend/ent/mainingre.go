...
type MainingreEdges struct {
	// MAININGRERECORD holds the value of the MAININGRERECORD edge.
...
func (e MainingreEdges) MAININGRERECORDOrErr() ([]*Recordfood, error) {
	...
	return nil, &NotLoadedError{edge: "MAININGRERECORD"}
}
...
// QueryMAININGRERECORD queries the MAININGRERECORD edge of the Mainingre.
