...
func (uc *UserCreate) AddUSERRECORDIDs(ids ...int) *UserCreate {
	uc.mutation.AddUSERRECORDIDs(ids...)
	return uc
}

// AddUSERRECORD adds the USERRECORD edges to Recordfood.
func (uc *UserCreate) AddUSERRECORD(r ...*Recordfood) *UserCreate {
	ids := make([]int, len(r))
	for i := range r {
		ids[i] = r[i].ID
	}
	return uc.AddUSERRECORDIDs(ids...)
}
...
func (uc *UserCreate) check() error {
	if _, ok := uc.mutation.USEREMAIL(); !ok {
		return &ValidationError{Name: "USER_EMAIL", err: errors.New("ent: missing required field \"USER_EMAIL\"")}
	}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.USERRECORDIDs(); len(nodes) > 0 {
