...
const (
	...
	// EdgeSOURCERECORD holds the string denoting the sourcerecord edge name in mutations.
	EdgeSOURCERECORD = "SOURCERECORD"

	// Table holds the table name of the source in the database.
	Table = "sources"
	// SOURCERECORDTable is the table the holds the SOURCERECORD relation/edge.
	...
	// SOURCERECORDColumn is the table column denoting the SOURCERECORD relation/edge.
	SOURCERECORDColumn = "source_sourcerecord"
)
