...
var (
	...
	RecordfoodsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "foodmenu_foodmenurecord", Type: field.TypeInt, Nullable: true},
		{Name: "mainingre_mainingrerecord", Type: field.TypeInt, Nullable: true},
		{Name: "source_sourcerecord", Type: field.TypeInt, Nullable: true},
		{Name: "user_userrecord", Type: field.TypeInt, Nullable: true},
	}
	...
	RecordfoodsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:  "recordfoods_foodmen_us_FOODMENURECORD",
			...
			{
				Symbol:  "recordfoods_mainingres_MAININGRERECORD",
			...
			{
				Symbol:  "recordfoods_sources_SOURCERECORD",
			...
			{
				Symbol:  "recordfoods_users_USERRECORD",
